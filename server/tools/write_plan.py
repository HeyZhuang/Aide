...
@tool(args_schema=StepsInput)
def write_plan_tool(
    steps: List[Step],
    config: RunnableConfig,
    tool_call_id: Annotated[str, InjectedToolArg],
) -> str:
    """Write a plan to complete the current task in the order of execution, including the steps and the description of each step. The plan should be friendly to showcase to the user."""
